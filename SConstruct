...
# Import settings
CONFIG_VARS = ['TARGET', 'MCU', 'F_CPU', 'AVR_GCC_PATH', 'INCPATH', 'LIBPATH', 'SRCPATH', 'LIBS', 'ARDUINO_BOARD', 'ARDUINO_HOME', 'AVRDUDE_PORT', 'UPLOAD_PROTOCOL', 'UPLOAD_SPEED', 'ARDUINO_SKETCHBOOK_HOME', 'ARDUINO_VER', 'ARDUINO_EXTRA_LIBRARIES_PATH', 'ARDUINO_EXTRA_LIBRARIES', 'RST_TRIGGER', 'AVRDUDE_CONF', 'EXTRA_SOURCES', 'CPPFLAGS']
